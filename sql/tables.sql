...
--
-- Table structure for table `shop_aftersale`
--

DROP TABLE IF EXISTS `shop_aftersale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_aftersale` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `shop_coupon_user`
--
...
--
-- Table structure for table `shop_footprint`
--
...
--
-- Table structure for table `shop_goods_attribute`
--
...
--
-- Table structure for table `shop_goods_product`
--
...
--
-- Table structure for table `shop_goods_specification`
--
...
--
-- Table structure for table `shop_groupon`
--
...
CREATE TABLE `shop_groupon` (
    ...
    `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联shop_groupon_rules表ID字段',
    `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `shop_groupon_rules`
--

DROP TABLE IF EXISTS `shop_groupon_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_groupon_rules` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `shop_issue`
--
...
--
-- Table structure for table `shop_keyword`
--
...
--
-- Table structure for table `shop_notice_admin`
--

DROP TABLE IF EXISTS `shop_notice_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_notice_admin` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `shop_storage`
--
...
--
-- Table structure for table `shop_system`
--
...
CREATE TABLE `shop_about` (
    ...
    `context` varchar(255) DEFAULT NULL COMMENT '答案',
    `add_time` datetime DEFAULT NULL COMMENT '创建时间',
    `update_time` datetime DEFAULT NULL COMMENT '更新时间',
    `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
     PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='关于我们表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `shop_order_express`
--
...
CREATE TABLE `shop_order_express` (
  ...
  `request_time` datetime NOT NULL COMMENT '最近一次向第三方查询物流信息时间',
